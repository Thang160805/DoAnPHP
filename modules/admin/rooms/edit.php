                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="diachi" class="form-control"
                                                value="<?= htmlspecialchars($room['DiaChi']) ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="description" class="form-control"
                                            rows="4"><?= htmlspecialchars($room['description']) ?></textarea>
                                    </div>

                                    <div class="col-12">
                                        <label class="form-label">Trạng thái hiển thị</label>
                                        <select name="trangthai" class="form-select">
                                            <option value="1" <?= $room['TrangThai']==1?'selected':'' ?>>✔️ Đã duyệt
                                            </option>
                                            <option value="0" <?= $room['TrangThai']==0?'selected':'' ?>>⏳ Chờ duyệt
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-4">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        ?>
                                            <img src="<?= htmlspecialchars($displayImg) ?>" alt="Ảnh phòng"
                                                class="img-preview" id="currentImage"
                                    ...
                                    <input type="file" name="anhchinh" id="imgInput" class="form-control"
                                        accept="image/*">
                                    <div class="form-text text-muted">Chọn ảnh mới (JPG, PNG, GIF, WEBP - tối đa 5MB)
                                    </div>
